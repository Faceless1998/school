      ...
      <div className='contact-info'>
        <div className="content">
          ...
          <div className="contact-item">
            <FaPhone aria-label="Phone" /> <span>+995 422 276218</span>
          </div>
          <div className="contact-item">
            <TbBrandGmail aria-label="Email" /> <span>andriapirvelw.skola@gmail.com</span>
          </div>
          <div className="contact-item">
            <CiLocationOn aria-label="Location" /> <span>ქ.ბათუმი დემეტრე თავდადებულის 49</span>
          </div>
        </div>
      </div>
      <div className='map'>
